...
POLL_INTERVAL_HOURS defaults to 24. This is a plain sleep loop that calls
runner.run_once() on a timer. Deploying it (systemd timer, cron entry,
container with a restart policy) is an operational choice outside this
module's scope.
"""
